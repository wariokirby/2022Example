...
public class AcquireCargo extends CommandBase {
  private Drivetrain drivetrain;
  private CargoTracker tracker;
  private int[] trackerData;
  private final int SIZE_WHEN_CAUGHT = 20;
  //TODO need to measure this

  /** Creates a new AcquireCargo. */
  public AcquireCargo(Drivetrain drivetrain , CargoTracker tracker) {
  ...
  public void execute() {
    ...
    if(trackerData[0] == 200){
      ...
      drivetrain.drive(0, (trackerData[0] / 157));
    }
  }
